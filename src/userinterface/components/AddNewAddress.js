...
useEffect(()=>{
 ...
 const [state,setstate]=useState()
   ...
   const handleAddrSubmit=async()=>{
    ...
    <div onClick={handleAddrSubmit} style={{width:'24vw',height:'6vh',border:'1px solid',borderRadius:'20px',borderColor:'#0078ad',marginTop:'8vh',marginLeft:'25px',display:'flex',justifyContent:'center',alignItems:'center',background:'#0078ad'}}>
      <span  style={{fontFamily:'JioType, helvetica, arial, sans-serif',fontWeight:'bold',letterSpacing:'0.8px',color:'#fff'}}>Save & Proceed</span>
    </div>
    </div>)}
