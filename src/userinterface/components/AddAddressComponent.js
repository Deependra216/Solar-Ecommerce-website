        ...
        >
          <div style={{ width: "90%", marginTop: "5%" }}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ color: "grey", fontSize: ".7rem" }}>
                      Using GPS
                    </div>
                  </div>
                </div>
              ...
              <Grid item xs={6}>
                <TextField
                  error={errorMessage.houseno}
                  helperText={errorMessage.houseno}
                  onFocus={() => {
                    handelError("", "houseno");
                  }}
                  label="House No."
              ...
              <Grid item xs={6}>
                <TextField
                  error={errorMessage.floorno}
                  helperText={errorMessage.floorno}
                  onFocus={() => {
                    handelError("", "floorno");
                  }}
                  label="Floor No."
              ...
              <Grid item xs={12}>
                <TextField
                  error={errorMessage.towerno}
                  helperText={errorMessage.towerno}
                  onFocus={() => {
                    handelError("", "towerno");
                  }}
                  label="Tower No."
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  helperText={errorMessage.building}
                  onFocus={() => {
                    handelError("", "building");
                  }}
              ...
              <Grid item xs={12}>
                <TextField
                  error={errorMessage.landmark}
                  helperText={errorMessage.landmark}
                  onFocus={() => {
                    handelError("", "landmark");
                  }}
                  label="Landmark / Area *"
                  variant="standard"
                  fullWidth
              ...
              <Grid item xs={12} style={{ marginTop: "8%" }}>
                <Button
                  fullWidth
                  variant="contained"
                  style={{ borderRadius: 25, background: "#54a0ff" }}
